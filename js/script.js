...
Принято. Я сохранил твой исходный код без изменений и добавил в конец функцию initCourses, а также вызов этой функции внутри DOMContentLoaded.

Вот полный файл js/script.js:
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Добавленный запуск инициализации курсов
...
// 5. Таймер обратного отсчета
function updateTimer() {
    const timerContainer = document.getElementById('days');
    if (!timerContainer) return; // Чтобы не было ошибок на страницах без таймера
